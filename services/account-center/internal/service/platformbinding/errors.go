...
var (
	...
	ErrCredentialOperationNotFound       = errors.New("platform credential operation not found")
	ErrCredentialOperationNotRecoverable = errors.New("platform credential operation is not recoverable")
