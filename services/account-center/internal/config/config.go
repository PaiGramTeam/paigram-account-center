...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("app.cors.allow_headers", []string{"Origin", "Content-Type", "Accept", "Authorization", "X-Request-ID", "traceparent"})
	v.SetDefault("app.cors.expose_headers", []string{"X-Request-ID", "traceparent"})
