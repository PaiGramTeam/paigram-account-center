...
func TestUnifiedUserPlatformSchema(t *testing.T) {
	...
	requireForeignKeyExists(t, stack.SQLDB, stack.Schema, "platform_operation_intents", "fk_platform_operation_intents_binding")
	requireForeignKeyExists(t, stack.SQLDB, stack.Schema, "platform_operation_intents", "fk_platform_operation_intents_binding_identity")
	requireForeignKeyExists(t, stack.SQLDB, stack.Schema, "platform_operation_intents", "fk_platform_operation_intents_owner")
	requireForeignKeyExists(t, stack.SQLDB, stack.Schema, "platform_operation_outbox", "fk_platform_operation_outbox_intent")
