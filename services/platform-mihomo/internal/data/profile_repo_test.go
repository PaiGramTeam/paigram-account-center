...
func TestProfileRepoListByBindingRefReturnsOnlyBindingProfiles(t *testing.T) {
	db := newRepoTestDB(t)
	...
	profiles, err := repo.ListByBindingRef(context.Background(), "binding-42")
...
func TestProfileRepoAllowsSamePlayerAndRegionAcrossBindings(t *testing.T) {
	...
	first, err := repo.ListByBindingRef(context.Background(), "binding-42")
	require.NoError(t, err)
	require.Len(t, first, 1)
	require.Equal(t, "Traveler", first[0].Nickname)

	second, err := repo.ListByBindingRef(context.Background(), "binding-7")
	require.NoError(t, err)
...
func TestProfileRepoSetDefaultSwitchesProfiles(t *testing.T) {
	...
	require.NoError(t, repo.SetDefaultByBindingAndPlayerID(context.Background(), "binding-42", "binding_42_10001", "2000222"))
...
func TestProfileRepoSetDefaultClearsExistingDefaultAcrossPlatformAccounts(t *testing.T) {
	...
	require.NoError(t, repo.SetDefaultByBindingAndPlayerID(context.Background(), "binding-42", "binding_42_20002", "2000222"))
...
func TestProfileRepoSetDefaultReturnsNotFoundForMissingProfile(t *testing.T) {
	...
	err := repo.SetDefaultByBindingAndPlayerID(context.Background(), "binding-42", "binding_42_10001", "missing")
